...
function onSignIn(googleToken) {
  ...
  function credentialExchange(googleToken) {
    ...
    if (googleTokenDecoded['sub']) {
      ...
      AWS.config.credentials = new AWS.CognitoIdentityCredentials({
        IdentityPoolId: 'us-east-1:b95ef956-5060-4743-90e5-7926510487a3', // MAKE SURE YOU REPLACE THIS
        Logins: {
  ...
  function accessImages() {
    ...
    var s3 = new AWS.S3();
    var params = {
      Bucket: "webidf-patchesprivatebucket-1oanor3mzby4w" // MAKE SURE YOU REPLACE THIS
    }; 
